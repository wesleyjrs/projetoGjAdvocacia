...
<body>
    ...
    <main class="main">
        ...
        <!-- Begin latest news -->
        <section class="section section-bgc" style="margin-top: 50px;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="news-item-info">
                                ...
                                <div class="news-item-desc">
                                    <p class="texto_areas">O inventário é um documento que reúne a listagem dos bens que uma pessoa — física ou jurídica — tem. Em caso
                                        de falecimento, é preciso registrar essa relação de bens, direitos e obrigações, para que seja possível
                            ...
                            <div class="news-item-info">
                                ...
                                <div class="news-item-desc">
                                    <p class="texto_areas">A pensão alimentícia é um valor usado para garantir a subsistência de uma pessoa que não pode se
                                        manter por conta própria. Dessa forma, a pensão nada mais é do que um pagamento, realizado geralmente
                                        todos os meses. </p><br>
                                </div>
                            </div>
                            <div class="section-btns justify-content-center">
                            ...
                            <div class="news-item-info">
                                ...
                                <div class="news-item-desc">
                                    <p class="texto_areas">Você Policial Militar pode ingressar com ação judicial para requerer o recálculo do adicional por tempo de serviço de modo
                                        que incida sobre todos os vencimentos, e não somente sobre o vencimento padrão. </p><br><br>
                                </div>
                            </div>
                            <div class="section-btns justify-content-center">
                            ...
                            <div class="news-item-info">
                                ...
                                <div class="news-item-desc">
                                    <p class="texto_areas">O STF (Supremo Tribunal Federal), órgão máximo do Poder Judiciário, julgou inconstitucional o artigo 24-C, da Lei Federal 13.954/2019,
                                        que determinava uma cobrança de 10,5% sobre a totalidade dos proventos de inatividade, desde 15 de março de 2020.</p>
                                </div>
                            </div>
                            <div class="section-btns justify-content-center">
